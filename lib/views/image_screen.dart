        ...
        children: [
          ...
          Expanded(
            ...
            child: PrimaryInputField(
              ...
              onTap: () async {
                debugPrint("---------${_imageController.count.value.toString()}-----------");
                debugPrint("---------${_imageController.count.value.toString()}-----------");
                ...
                if(LocalStorage.showAdPermissioned()){
                  ...
                  if(_imageController.count.value <= 10){
                    ...
                    ToastMessage.error('Image Limit is over. Buy subscription.');
                  }
                }
    ...
    return Obx(() {
      return _imageController.isVisible
        ...
        child: Padding(
          ...
          child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: (){
                    _showDialog(context, _imageController.imageModel.data[index].url);
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(_imageController.imageModel.data[index].url),
                            fit: BoxFit.fill
                        )
                    ),
                  ),
        ...
        builder: (context, value, child){
          return       Text(Strings.searchSomething.tr.substring(0, value),
            style: TextStyle(
                    ...
                    child: TextButton(
                        onPressed: () {
                          if(index == 0){
                            ...
                            _imageController.shareImage(context, url, _imageTextController.text);
                          }
                          Get.back();
                        },
                        child: Text(
