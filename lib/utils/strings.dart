class Strings {
  ...
  static const String chatWithChatBot = "Chat With ChatGPT";
  static const String chatWithChatBotSubTitle = "Chatting with ChatGPT can be a fun and interactive way to explore language and learn new things. ";
  static const String settings = "Settings";
  static const String token = "Token";
  static const String cancel = "Cancel";
  static const String save = "Save";
  static const String skip = "Skip";
  static const String subscriptionPlan = "Premium Subscription Plan";
  static const String freeSubscription = "Free Subscription";
  static const String notIncluded = "Not Included";
  static const String limitedChatting = "Limited Chatting With ChatGPT";
  static const String limitedCImage = "Limited Image Generate";
  static const String unlimitedChatting = "Unlimited Chatting With ChatGPT";
